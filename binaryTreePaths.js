    ...
    if (dir == 0) {
      ...
      if (current.left) {
        ...
        if (stack.length > 0) {
          ...
          let lastNodeIndexInResult = result.lastIndexOf(lastNode.val);
          result = result.slice(0, lastNodeIndexInResult + 1);
          current = stack.pop();
          dir = 1;
        } else {
          break;
